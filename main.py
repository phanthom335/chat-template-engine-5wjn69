    """
    Chat Template Engine 5wjn69
    ===========================
    A Python-based AI utility that summarises text using modern language model APIs.
    ...
    APP_NAME    = "Chat Template Engine 5wjn69"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A Python-based AI utility that summarises text using modern language model APIs.")
